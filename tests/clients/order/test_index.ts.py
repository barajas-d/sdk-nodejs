...
describe('Order client', () => {
	...
	describe('create', () => {
		test('should call create with correct parameters', async () => {
			...
			const mockResponse = { id: 'order_123', status: 'pending' };
	...
	describe('get', () => {
		...
		test('should merge request options with config options', async () => {
			...
			await order.get({ id: 'order_123', requestOptions });
	...
	describe('process', () => {
		...
		test('should merge request options with config options', async () => {
			...
			await order.process({ id: 'order_123', requestOptions });
	...
	describe('cancel', () => {
		...
		test('should merge request options with config options', async () => {
			...
			await order.cancel({ id: 'order_123', requestOptions });
	...
	describe('capture', () => {
		...
		test('should merge request options with config options', async () => {
			...
			await order.capture({ id: 'order_123', requestOptions });
	...
	describe('refund', () => {
		test('should call refund with correct parameters for full refund', async () => {
			const id = 'order_123';
		...
		test('should merge request options with config options', async () => {
			...
			await order.refund({ id: 'order_123', requestOptions });
	...
	describe('createTransaction', () => {
		test('should call createTransaction with correct parameters', async () => {
			...
			const mockResponse = {
				payments: [
					{ id: 'trans_123', amount: '100.00', status: 'pending' }
				]
			};
		...
		test('should merge request options with config options', async () => {
			...
			await order.createTransaction({ id: 'order_123', body, requestOptions });
