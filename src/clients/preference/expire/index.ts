 ...
 *
 * Sends a PUT request to `/checkout/preferences/:id/expire` to mark a
 * preference as expired, preventing further checkouts using its URL.
 *
 * @module preference/expire
 */
