 ...
 * the `/checkout/preferences` resource. Preferences configure payment
 * options, items, shipping, and redirect URLs for the MercadoPago
 * checkout flow.
 *
 ...
 *
 * Exposes CRUD operations on checkout preferences. Preferences define
 * the configuration for a MercadoPago checkout session including items,
 * payment methods, shipment options, and callback URLs.
 *
