 ...
 * payment methods, and user experience for MercadoPago's hosted checkout.
 *
 ...
 *
 * Exposes CRUD operations on checkout preferences (except delete).
 * Preferences define the checkout experience including items, payment
 * methods, shipping options, and callback URLs.
 *
