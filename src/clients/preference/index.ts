 ...
 * payment methods, redirect URLs, and other checkout configuration for
 * a buyer-initiated payment flow.
 *
 ...
 *
 * Exposes CRUD operations on checkout preferences, which define the
 * configuration for a buyer-initiated payment flow (items, amounts,
 * payment methods, redirect URLs, etc.).
 *
...
export class Preference {
	...
	/**
	 * Create a new payment preference in MercadoPago.
	 *
